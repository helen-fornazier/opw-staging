...
{
	const struct vimc_pix_map *vpix;
	struct v4l2_mbus_framefmt mf = fmt_default;
	...
	mf.width = clamp_t(u32, fmt->width, MIN_WIDTH, MAX_WIDTH);
	mf.height = clamp_t(u32, fmt->height, MIN_HEIGHT, MAX_HEIGHT);
